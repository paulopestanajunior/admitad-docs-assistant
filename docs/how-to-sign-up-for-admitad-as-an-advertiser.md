---
title: How to sign up for Admitad as an advertiser
section: general-information
source: https://support.mitgo.com/knowledge-base/article/how-to-sign-up-for-admitad-as-an-advertiser_6
---
...
- [Admitad for advertisers: the basics](https://support.admitad.com/hc/en-us/articles/4405926783505)
- [Admitad advertiser requirements](https://support.admitad.com/hc/en-us/articles/7827936586257)
- [Documents required for cooperation with Admitad](https://support.admitad.com/hc/en-us/articles/7828033872145)
...
- If you opt for the Rise rate, your next step will be [to set up the program](https://docs.google.com/document/d/1NKH3d17lcDkHXbDl9Q0sht2FCb4-jjL0sWg7i23kLxo/edit?tab=t.0#heading=h.kkx9geyx4uah), following the prompts in the interface.
...
5. Link your bank card to Stripe.\*

\*This step is relevant for countries that have access to self\-configuration, except for Ukraine. Advertisers from Ukraine pay for services through the Admitad manager.

7. Set up integration (this step is relevant only if you have chosen a program type with link tracking). Assistance from your company's technical specialist will be required.
