---
title: How to configure rules for traffic sources in an Admitad program
category: admitad-advertisers
section: affiliate-program-settings
language: en
source: https://support.mitgo.com/knowledge-base/article/how-to-configure-rules-for-traffic-sources-in-an-admitad-program_4
---

# How to configure rules for traffic sources in an Admitad program

[Traffic sources](https://support.admitad.com/hc/en-us/articles/360019245297) allow publishers to attract users to your website and/or app, as well as to promote your products or services.
 ...
 *If you don't know which traffic sources should be allowed and which should be prohibited, read the tips in [this section](#recommendations) and then configure the rules using [these instructions](#traffic-types-settings).*
...
If you want a manager to set up your program, switch to Plus or Enterprise plan. [Learn more](https://admitad.useresponse.com/knowledge-base/article/plans-for-advertisers-how-to-choose-or-change-a-plan_5)
...
- Once the program is launched, the rules for traffic sources can be changed only by the manager or by sending a request to the support service at [support@admitad.com](mailto:support@admitad.com). See [more](#change-traffic-types)
...
- [Show on the program page](#show-traffic-types)
- [Permissions](#permissions-for-traffic-types)
- [Auto\-connection for publishers](#auto-moderation-of-publishers)
...
Publishers with this traffic source can still submit a request to connect to your program. It will be sent for [manual moderation](https://support.admitad.com/hc/en-us/articles/4405926847377#manual-moderation).
...
- Needs approval — select this if you have doubts about a certain traffic source.
	- In this case, requests from publishers with this traffic source will be sent for [manual moderation](https://support.admitad.com/hc/en-us/articles/4405926847377#manual-moderation), and you will be able to review them one by one.
...
- If the [ad space](https://support.admitad.com/hc/en-us/articles/4403304880529#ad-space-en) type and [publisher's account level](https://support.admitad.com/hc/en-us/articles/4403304880529#account-level-en) correspond to the conditions in the settings, the publisher will submit a request to connect to your program, and their ad space will be instantly connected to the program. [Learn more about auto\-moderation](https://support.admitad.com/hc/en-us/articles/4405926847377#automoderation)
...
- Ad space type — place checkmarks by the types of [ad spaces](https://support.admitad.com/hc/en-us/articles/4403304880529#ad-space-en) that will connect to the program automatically.
- Account level — place checkmarks next to the appropriate [account levels](https://support.admitad.com/hc/en-us/articles/4403304880529#account-level-en).
...
| --- | --- | --- |
| Not launched yet | Change the settings using [these instructions](#traffic-types-settings). | Contact your manager and ask them to make the changes. |
| Already launched | Contact the support service at [support@admitad.com](mailto:support@admitad.com) and ask them to make the changes. | Contact your manager and ask them to make the changes. |
...
If you are afraid that you will receive low\-quality traffic due to lenient requirements, set up manual moderation for the specific sources that you have doubts about and check the ad spaces with these traffic sources one by one. [Learn more about manual moderation](https://support.admitad.com/hc/en-us/articles/4405926847377#manual-moderation)

  
Press the traffic source to view tips for it.

- [Brand bidding](https://support.admitad.com/hc/en-us/articles/4403304880529#brand-bidding-en) is a type of contextual advertising that mentions your brand. 
...
- With this traffic source, publishers attract users by promising non\-monetary rewards (points, bonuses, gifts) for performing [target actions](https://support.admitad.com/hc/en-us/articles/4403304880529#action-en).
...
For example, a request to get credit, open a bank account, sign up for insurance, and so on. [Learn more about API traffic](https://support.admitad.com/hc/en-us/articles/4405926810769)
...
Advertisers often prohibit [Pop\-Up](https://support.admitad.com/hc/en-us/articles/4403304880529-%D0%93%D0%BB%D0%BE%D1%81%D1%81%D0%B0%D1%80%D0%B8%D0%B9#pop-up-en) and [Click\-Under](https://support.admitad.com/hc/en-us/articles/4403304880529-%D0%93%D0%BB%D0%BE%D1%81%D1%81%D0%B0%D1%80%D0%B8%D0%B9#click-under-en) due to the prevailing opinion that they are annoying and ineffective. However, it all depends on the professionalism and integrity of the publishers that you work with. 
...
It doesn't matter what the means or format of advertisement placement is, i.e., mobile traffic can actually be attracted from any type of ad space. 
	...
	- When to allow it: Only if your program has a configured option to track target actions made from mobile devices and you are willing to pay publishers for such actions. [Learn more about mobile tracking](https://support.admitad.com/hc/en-us/articles/4405926817809)
