---
title: Bonuses and bonus programs
category: admitad-advertisers
section: tools_1
language: en
source: https://support.mitgo.com/knowledge-base/article/bonuses-and-bonus-programs_4
---
...
- [using bonus programs (i. e. automatically)](#h_01FD9RN3D4772J9QZ3JWCGFF2S)
- [manually](#Manual-bonuses)

​

## What type of bonus to choose

If you need to regularly pay bonuses to a significant number of publishers, it is more convenient to set up a bonus program. Bonuses will be automatically accrued for fulfilling the bonus program conditions. [More on bonus programs](#h_01FD9RN3D4772J9QZ3JWCGFF2S)

However, if you reward publishers for winning a contest or raffle (i.e., it is a one\-time action and a smaller number of winners), it is easier to process a bonus manually. You will also have to use manual bonuses if the terms of your program do not allow you to launch a bonus program. [More on manual bonuses](#Manual-bonuses)
...
Bonus programs are configured by Admitad managers. You can see a list of bonus programs in the Bonus programs section (Advertising tools → Extra reward → Bonus programs). [How to launch a bonus program](#How%20to%20launch%20a%20bonus%20program)
...
Payment amount— specify the increased reward (fixed or percentage), percentage of the publisher's earnings, or a fixed reward.
...
- [Through your personal account](#add-manual-bonus-singly)
- [Through your manager](#add-manual-bonus-by-manager)
...
If it's paid advertising on the publisher's ad space, choose the appropriate option from the list below and specify it as the reason:
	...
	- CPM (cost per mille) — payment for advertising per 1000 displays of the ad unitIf a relevant reason is missing from the list, or if the bonus is not related to paid placement, provide a free\-form description of why the publisher will be receiving the bonus.
