...
Deeplink is set up by your account manager in [General settings](https://admitad.useresponse.com/knowledge-base/article/how-to-fill-out-the-general-program-settings-in-admitad_5) when preparing the program for the launch. Such links contain the same parameters as the standard link.
