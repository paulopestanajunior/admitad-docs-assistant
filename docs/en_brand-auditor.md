...
section: tools_1
language: en
source: https://support.mitgo.com/knowledge-base/article/brand-auditor_6
---

# Brand Auditor

In case you don't want to work with particular ad spaces or traffic types, you can forbid them in [program rules](https://support.admitad.com/hc/en-us/articles/4405920516113).


For instance, you promote your brand using contextual advertising and don't want publishers' ads to overlap yours. In this case, you forbid the "[Brand bidding](https://support.admitad.com/hc/en-us/articles/4403304880529#brand-bidding-en)" traffic type. Further on, using your brand name in search requests will be considered a violation.
...
Brand Auditor is a tool that checks search results of requests containing your brand name. The check is conducted in such search engines as Google, Bing, Yahoo.
...
Prepare a list of [negative words](https://support.admitad.com/hc/en-us/articles/4403304880529#negative-keywords-en) that will be forbidden for publishers' use. Save it as an .xlsx file or simply a list, if there are not many such words.
