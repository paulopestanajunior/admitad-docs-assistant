---
title: How to add your affiliate program rules in Admitad
section: affiliate-program-settings
source: https://support.mitgo.com/knowledge-base/article/how-to-add-your-affiliate-program-rules-in-admitad_5
---

# How to add your affiliate program rules in Admitad

The rules you create for your affiliate program are the terms, restrictions, and requirements that you expect your publishers to comply with if they choose to join your program.
...
Your publishers can view your rules in the Program rules section, on the page of your program in the [Admitad Store](https://store.admitad.com/en/catalog/) catalog. Publishers also read and accept the rules when submitting a request for joining a program.
...
[Guidelines for configuring your program rules](https://support.admitad.com/hc/en-us/articles/4405920516113#how-to-prepare-program-rules)
...
See below [the guidelines and suggestions for configuring your program rules](https://support.admitad.com/hc/en-us/articles/4405920516113#how-to-prepare-program-rules).

- If publishers from other countries have joined your program, make sure to have your program rules translated into their native languages (see [how to have your rules translated](https://support.admitad.com/hc/en-us/articles/4405920516113#how-to-add-program-rules-translation)).
- If you need to update your program rules, feel free to consult our [manual](https://support.admitad.com/hc/en-us/articles/4405920516113#how-to-edit-program-rules).
...
In addition to providing the translation of your program rules, we also recommend providing translations of the program name, the program overview, and a brief description. [Read more about how to add this information](https://support.admitad.com/hc/en-us/articles/4405926792849).
...
| Program status | Self\-managed | Manager\-managed |
| --- | --- | --- |
| Program pending | Update your Rules (Program → Program profile → Rules). | Refer to your manager for assistance in updating your program rules. |
| Program running | Refer to Admitad Support, at support@admitad.com, for assistance in updating your program rules. | Refer to your manager for assistance in updating your program rules. |
...
- [How to configure the general settings of your program in Admitad](https://support.admitad.com/hc/en-us/articles/4405926794513)
- [How to add a description of your affiliate program in Admitad](https://support.admitad.com/hc/en-us/articles/4405926792849)
- [How to configure your traffic sources in Admitad](https://support.admitad.com/hc/en-us/articles/4405920514193)
